...
try{
	...
	ResultSet rs1=st.executeQuery
			("select sum(total) from cart where email='"+email+"'  and address is NULL");
	while(rs1.next())
	{
		total=rs1.getInt(1);
	}
%>
      ...
      ("select * from product inner join cart on product.id=cart.product_id and cart.email='"
      ...
      %>
          ...
          <%sno=sno+1; %>
           ...
           <%}
      ResultSet rs2=st.executeQuery("select * from users2 where email='"+email+"'");
      while(rs2.next())
      {  
      %>
        </tbody>
...
<hr style="width: 100%">
<form action="addressPaymentForAction.jsp" method="post">
 <div class="left-div">
 <h3>Enter Address</h3>
...
<div class="right-div">
<h3>Pay online on this bcsdays@pay.com</h3>
