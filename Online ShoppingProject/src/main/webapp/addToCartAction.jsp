...
try{
	...
	ResultSet rs1=st.executeQuery("select * from cart where product_id='"
	...
	if(z==1){
		st.executeUpdate("update cart set total='"+cart_total+"',quantity='"
	+quantity+"'  where product_id='"+product_id+"'  and email='"
